...
#파일 추가
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", filetypes=(("PNG 파일", "*.png"),("모든 파일","*.*") ), initialdir=r"C:\Users\ge729\OneDrive\바탕 화면\PythonWorkspace")
...
def merge_image():
    ...
    try:
        ...
        #      xy' = x'y
        # 우리 코드에 대입하려면?
        # x = width = size[0]  x' = img_width
        # y = height =size[1]  y' = img_width * size[1] / size[0]
...
scrollbar.config(command=list_file.yview) #맵핑
